...
namespace BLL
{
    public class SingleLearner
    {
        ...
        {
            return Request.cToDTO(data.db.request_tbl.Where(r => r.donorEmail.Equals(donorEmail)).ToList());
        }
        public static List<Book> getBooksByDonor(string donorEmail)
        {
            
            List<Request>   reqsResult= Request.cToDTO(data.db.request_tbl.Where(r => r.donorEmail.Equals(donorEmail)).ToList());
        ...
        public static List<Book> getBooksByReqs(List<Request> reqs)
        {
            ...
            List<Book> allBooks = Book.cToDTO(data.db.Book_tbl.ToList());
        ...
        public static List<Request> SingleLearnerForSingleDonorReqs(int learnerId, string donorId)
        {
            ...
            matchRes=Matching.cToDTO(data.db.Matching_tbl.AsNoTracking().Where(m => 
        ...
        {
            List<Learner> allLearners = Learner.cToDTO(data.db.learners_tbl.ToList());
        ...
        public static List<Learner> GetLearnesForBookByDonor(int bookId, string donorId)
        {
            ...
            //get reqs for donor
            List<Request> allRequests = Request.cToDTO(data.db.request_tbl.ToList());
            ...
            List<Matching> allMatchings = Matching.cToDTO(data.db.Matching_tbl.AsNoTracking().ToList());
        ...
        {
            var l = Matching.cToDTO(data.db.Matching_tbl.AsNoTracking().Where(m => m.reqId == requestId).ToList());
        ...
        {
            return data.db.Matching_tbl.AsNoTracking().Count(x => x.bookId == book);
        }
        /// <summary>
        ...
        {
            int id = data.db.Book_tbl.FirstOrDefault(b => b.BookId == book.BookId).BookId;
            return data.db.Matching_tbl.AsNoTracking().Count(x => x.bookId == id);
        }
        ///// <summary>
